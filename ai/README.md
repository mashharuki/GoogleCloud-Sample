# Google Cloud AI 関連サービスメモ


### 参考文献
1. [Vertex AI 公式ドキュメント](https://cloud.google.com/vertex-ai/docs?hl=ja)
2. [Google Cloud 生成 AI サービスまとめ](https://cloud-ace.jp/column/detail433/)
3. [Google Cloud AIと機械学習の公式ドキュメント](https://cloud.google.com/products/ai?hl=ja)
4. [Cloud Run に Gemini を活用したチャットアプリをデプロイする方法](https://codelabs.developers.google.com/codelabs/how-to-deploy-gemini-powered-chat-app-cloud-run?hl=ja#0)
5. [GitHub - GoogleCloudPlatform/generative-ai](https://github.com/GoogleCloudPlatform/generative-ai/tree/main)
6. [Zenn - Vertex AI(Gemini API)でGemini Proを試す](https://zenn.dev/harappa80/articles/vertexai_gemini)
